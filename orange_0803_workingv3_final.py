...
file_name = 'data/images/bottom_front.mp4'
cam_width = 640
cam_height = 480
                ...
                for *xyxy, conf, cls in reversed(det):
                    ...
                    if save_img or save_crop or view_img:  # Add bbox to image
                        ...
                        if c == 0:  # center
                            ...
                            x2 = int(xyxy[2].tolist()-xyxy[0].tolist())
                            y2 = int(xyxy[3].tolist()-xyxy[1].tolist())
...
if __name__ == '__main__':
    ...
    parser.add_argument('--source', type=str, default='data/images/bottom_front.mp4', help='file/dir/URL/glob, 0 for webcam')

...
f1 = open('0805palletpictest/velocity_time#7.csv','w')
f2 = open('0805palletpictest/pallet_info#7.csv','w')
#f3 = open('0805palletpictest/pallet_hole_info#7.csv','w')
                ...
                for *xyxy, conf, cls in reversed(det):
                    ...
                    if save_img or save_crop or view_img:  # Add bbox to image
                        ...
                        if c == 1:  # pallet
                            ...
                            #print('dist:',distancei,'width:',width,'height:',height,)
                            f2.write(f"'width:',{width},'height:',{height},'px00:',{pallet_x00},'py00:',{pallet_y00},'px01:',{pallet_x01},'py10:',{pallet_y10}\n")
 #print('dist:',distancei,'width:',width,'height:',height,'pallet_coordinate','px00:',pallet_x00,'py00:',pallet_y00,'px01:',pallet_x01,'py10:',pallet_y10)
                            # CHANGE FONT HERE
                            #cv2.putText(im0, angle_text, (ref_w - 30, ref_h), cv2.FONT_HERSHEY_COMPLEX, 3,
                            #            (0, 128, 229), 2)
                            img22 = PIL.Image.fromarray(im0, "RGB")
                            fn="0803_test1_2m_0d/1.5m_0degree_007/file" + str(count_img) + ".jpg"#############################################
                            img22.save(fn)
                            count_img += 1
                            f2.write(f"'width:',{width},'height:',{height},'px00:',{pallet_x00},'py00:',{pallet_y00},'px01:',{pallet_x01},'py10:',{pallet_y10}\n")
                            # ------------------------------------------------------------------------------------------------
                        if c == 2:  # pallet_hole                        
                            ...
                            # if hole_centerx < pallet_centerx :
                                ...
                                #cv2.putText(im0, f'{estimated_real_xdistance},{estimated_real_ydistance}', (ref_w - 550, ref_h - 550),cv2.FONT_HERSHEY_COMPLEX, 1, (224, 128, 229), 3)

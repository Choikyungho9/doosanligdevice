...
if __name__ == '__main__':
    ...
    parser.add_argument('--source', type=str, default='data/file1a.jpg', help='file/dir/URL/glob, 0 for webcam')
    ...
    tracker = LaserTracker(cam_width=640, cam_height=480, hue_min=20, hue_max=160, sat_min=155, sat_max=255,
